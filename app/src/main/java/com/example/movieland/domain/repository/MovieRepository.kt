...
interface MovieRepository {
    ...
    suspend fun getMovieDetail(movieId: Int, token: String): DetailDTO
    ...
    suspend fun getSearchMovie(query : String, page: Int, token: String): MovieResponse
    suspend fun getMovieImage(movieId: Int, page: Int, token: String): ImageResponse
}